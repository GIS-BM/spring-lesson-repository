...
public class Product {
  // Wrapper Class 타입 long으로 처리하
  // 값이 존재하지 않늘때는 null로 초기화됨
  private Long productId; // table의 column : procust_id BigGint
  ...
  public String toString() {
    return "Product [productId=" + productId + ", productName=" + productName + ", maker=" + maker + ", price=" + price
        + ", createdAt=" + createdAt + "]";
  }
}
