...
//    System.out.println("회원 등록"+registerResult); // 등록 회원수
    ...
    // select test
    // Mapper xml 에서 parameterType="String" resultType="org.kosa.myproject.mapper"을 명시하면 됨
//    Member member = memberMapper.findMemberById("Java");
...
//    System.out.println("수정후:"+memberMapper.findMemberById("mybatis"));
    ...
    // delete member
    String id = "mybatis";
    System.out.println(memberMapper.findMemberById(id)); // 황희찬 회원
