...
import com.example.myproject.model.MemberServiceImpl;
 ...
 *    높은 응집도 high cohesion  : Core는 Core에만 집중, Cross cutting은 별도로 전담
...
public class Spring09AopSolutionApplication implements CommandLineRunner {
  ...
  public void run(String... args) throws Exception {
    ...
    // 아래가 Spring Container가 주입해준 Proxy (CGLIB) 대리인 객체
    // AOP가 적용(Proxy 대리인이 AoP 기능 실행하고 core를 실행)
    System.out.println(memberService.getClass().getName());// CGLIB Proxy
